...
class API {
    ...
    private static function __jsonRequest($url, $data = '', $headers = array()){
        ...
        $headers[]  = 'User-Agent: ZabbixAPI v'.self::PHPAPI_VERSION.' - http://andrewfarley.com/zabbix_php_api';
        ...
        $opts = array(
        		...
        		CURLOPT_TIMEOUT => self::$instance->timeout,              // Maximum number of seconds to allow curl to process the entire request
